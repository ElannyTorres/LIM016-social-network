...
export const Home = () => {
  ...
  <section class="login">
    ...
    <div>
      ...
      <div class="form-email">
        ...
        <button class="button-login" id="button-login">
      ...
      <div class="social-media">
        <div class="face">
          <a href="https://www.facebook.com/" >
            <img src="https://cdn.icon-icons.com/icons2/91/PNG/512/facebook_16423.png" alt=""class="url-face">
          </a>
        </div>
        <div class="gmail">
          <a>
            <img src="https://sitelabs.es/wp-content/uploads/2017/12/google-logo-1-800x800.png" alt="" class="url-gmail" id="url-gmail">
          </a>
        </div>
      </div>
      <h3>¿No tienes cuenta?
        <div class="newCount">
          <a href="#/singUp"> Regístrate</a>
        </div>
      </h3>
    </div>
  </section>
  ...
  divElement.setAttribute('id', 'viewLogInGrid');
